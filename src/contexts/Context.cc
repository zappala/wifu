...
void Context::icontext_receive_buffer_not_empty(ReceiveBufferNotEmpty* e) {
    get_state()->state_receive_buffer_not_empty(this, e);
}

void Context::icontext_send_buffer_not_empty(SendBufferNotEmpty* e) {
    get_state()->state_send_buffer_not_empty(this, e);
}

void Context::icontext_send_buffer_not_full(SendBufferNotFull* e) {
