...
PacketLogger::~PacketLogger() {
    ...
    while (!items_.empty()) {
        ...
        packet_header.incl_len = item->get_packet()->get_ip_tot_length() + sizeof (fake_ethernet_header);
        packet_header.orig_len = item->get_packet()->get_ip_tot_length() + sizeof (fake_ethernet_header);
