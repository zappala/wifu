...
public:
    ...
    virtual void icontext_send_buffer_not_empty(SendBufferNotEmpty*) = 0;
    virtual void icontext_send_buffer_not_full(SendBufferNotFull*) = 0;
    virtual void icontext_receive_buffer_not_empty(ReceiveBufferNotEmpty*) = 0;
};
