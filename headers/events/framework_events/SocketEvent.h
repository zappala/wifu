...
public:
     ...
     *
     * @param message Message received from the front end library containing the information about the socket() BSD socket API call and some bookkeeping information.
