...
public:
     ...
     *
     * @param message Message received from the front end library containing the information about the close() BSD socket API call and some bookkeeping information.
     ...
     */
    CloseEvent(gcstring& message, gcstring& file, Socket* s);
