...
public:
     ...
     *
     * @param message Message received from the front end library containing the information about the listen() BSD socket API call and some bookkeeping information.
     ...
     */
    ListenEvent(gcstring& message, gcstring& file, Socket* s);
