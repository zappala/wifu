...
namespace {
	...
	//TODO: if this be enabled again they must be changed to gtest syntax; they are in UnitTest++ syntax
...
//			Timer t;
//			t.start();
//			WiFuPacket* p;// = new Packet(source, dest, (unsigned char*) data.c_str(), data.size());
